...
tingkat_kerumitan_mining = 4 # menentukan tingkat kerumitan
...
class Blockchain:
    ...
    def bukti_validasi(faktur_pajak, hash_sebelumnya, nonce, kerumitan=tingkat_kerumitan_mining):
        ...
        h.update(bukti)
        ekstrasi_hash = h.hexdigest() # hexdigest() akan memproses sidik hash dan mengumpan balik nilai dalam nilai hexadesimal
